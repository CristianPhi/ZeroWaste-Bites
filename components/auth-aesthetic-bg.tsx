      ...
      <div
        className={`pointer-events-none fixed inset-0 -z-20 ${
          isAuthFocus
            ...
            : "bg-[radial-gradient(circle_at_15%_15%,rgba(16,185,129,0.05),transparent_34%),radial-gradient(circle_at_80%_10%,rgba(120,113,108,0.07),transparent_38%),radial-gradient(circle_at_85%_80%,rgba(34,197,94,0.04),transparent_30%)] dark:bg-[radial-gradient(circle_at_15%_15%,rgba(16,185,129,0.2),transparent_34%),radial-gradient(circle_at_80%_10%,rgba(255,255,255,0.1),transparent_40%),radial-gradient(circle_at_85%_80%,rgba(34,197,94,0.16),transparent_34%)]"
        }`}
      />
      <div
        className={`pointer-events-none fixed inset-0 -z-10 bg-[linear-gradient(rgba(120,113,108,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(120,113,108,0.08)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-size-[36px_36px] mask-[radial-gradient(circle_at_center,black,transparent_78%)] ${
          isAuthFocus ? "opacity-100 dark:opacity-95" : "opacity-35 dark:opacity-45"
        }`}
      />
